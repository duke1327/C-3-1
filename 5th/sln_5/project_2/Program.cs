...
namespace project_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // else if (4.0 <= score < 4.5) { Console.WriteLine("우수"); }
            // else if (4.0 <= score and score < 4.5) { Console.WriteLine("우수"); }
            else if (4.0 <= score && score < 4.5) { Console.WriteLine("우수"); }
            else if (3.5 <= score && score < 4.0) { Console.WriteLine("아주 잘함"); }
            else if (3.0 <= score && score < 3.5) { Console.WriteLine("잘함"); }
            else if (2.5 <= score && score < 3.0) { Console.WriteLine("보통 잘함"); }
            else if (2.0 <= score && score < 2.5) { Console.WriteLine("보통"); }
            else if (1.5 <= score && score < 2.0) { Console.WriteLine("분발"); }
            else if (2.0 <= score && score < 1.5) { Console.WriteLine("많이 분발"); }
            else { Console.WriteLine("다음 학기에 만나요"); }
            Console.WriteLine();

            // 조건문 간단히 사용
            // if 조건문은 이전에 비교햇던 것이 자동으로 걸러지므로
            ...
            else if (2.0 <= score) { Console.WriteLine("많이 분발"); }
            else { Console.WriteLine("다음 학기에 만나요"); }
        }
    }
}
